document.addEventListener('DOMContentLoaded', () => {
    ...
    const countries = [
        { id: 'japan', name: 'Japan: Christmas with KFC', coords: [35.6895, 139.6917], description: 'In Japan, Christmas does not have a religious meaning as it does in other countries, as only 1% of the population is Christian. However, a unique tradition has emerged: eating fried chicken from KFC. This custom began in the 1970s with a successful advertising campaign promoting a special Christmas menu. Today, it is common for Japanese families to line up to pick up their Christmas meal at KFC.' },
